...
require_once 'vendor/geshi/geshi.php';

function markdown($txt) {
    return MarkdownGeshi_Parser::defaultTransform($txt);
}

class MarkdownGeshi_Parser extends Michelf\MarkdownExtra {
    /**
    ...
    function _doGeshi($shebangMatch) {
        ...
        $line = (int) (($shebangMatch['linenumber'] > 0) ? $shebangMatch['linenumber'] : 0);
        ...
        if($line) {
            ...
            preg_match('!^(\s*<div[^>]+>)(.*)(</div>)!s', $highlighted, $m);
